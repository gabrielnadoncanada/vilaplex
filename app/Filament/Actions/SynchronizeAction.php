...
use App\Commands\SynchronizeTranslationsCommand;
use App\Helpers\TranslationScanner;
...
class SynchronizeAction extends Action
{
    ...
    public static function synchronize(?SynchronizeTranslationsCommand $command = null): array
    {
        ...
        $result['deleted_count'] = Translation::query()
        ...
        foreach ($groupsAndKeys as $groupAndKey) {
            ...
            $existingItem = Translation::where('group', $groupAndKey['group'])
