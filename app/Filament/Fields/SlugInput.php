...
class SlugInput extends TextInput
{
    ...
    public function getVisitLinkLabel(): string
    {
        ...
        return $label ?: trans('filament.fields.slug_input.permalink_label_link_visit') . ' ' . $this->getSlugInputModelName();
    }

    public function slugInputLabelPrefix(?string $labelPrefix): static
    {
        $this->labelPrefix = $labelPrefix ?? trans('filament.fields.slug_input.permalink_label');
